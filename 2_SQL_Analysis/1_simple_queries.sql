...
-- Description: Queries designed to feed into BI dashboards (like Tableau/PowerBI) 
-- to visualize profit drivers, loss-making categories, and regional performance.
-- ================================================================================
...
-- 1.1 Average Profit by Product Category
...
-- 1.2 Top Loss-Making Subcategories
...
-- 2.1 Total Sales Revenue by Region
...
-- 2.2 Top 10 Most Profitable States
